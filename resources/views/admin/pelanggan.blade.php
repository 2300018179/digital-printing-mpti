...
<div class="flex flex-col max-w-7xl space-y-6">
    ...
    <form id="searchForm" action="{{ route('admin.pelanggan') }}" method="GET" class="flex items-center max-w-md">
        <div class="relative w-full">
            ...
            <input type="text" 
                   ...
                   class="w-full pl-10 pr-4 py-2 bg-white border border-red-300 rounded-xl text-xs font-medium text-gray-700 placeholder-gray-400 focus:outline-none focus:border-red-600 focus:ring-1 focus:ring-red-600 transition shadow-sm">
        </div>
    </form>
                ...
                <tbody class="divide-y divide-gray-100 font-medium text-gray-600">
                    ...
                    <tr>
                        <td colspan="6" class="py-8 px-4 text-center text-gray-400 italic">
                            @if(request('cari'))
                                Tidak ada pelanggan yang cocok dengan kata kunci "{{ request('cari') }}".
                            @else
                    ...
                    {{-- Menjaga Tinggi Tabel Tetap Konsisten --}}
                    @php
...
{{-- Script Pencarian Otomatis Dinamis --}}
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (searchInput && searchForm) {
            // Jika ada query pencarian, fokuskan kursor ke ujung input
            ...
            // Jalankan form submit otomatis 500ms setelah user selesai mengetik
