...
@section('title', 'Edit Pengumuman - Fantastic Digital Printing')
...
<div class="flex flex-col max-w-4xl space-y-6">
    ...
    <div>
        ...
        <p class="text-xs text-gray-500 mt-1">
            Ubah rincian pengumuman atau status penayangan informasi untuk pelanggan.
        </p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 text-xs font-medium text-gray-700">
                ...
                <div class="md:col-span-2 space-y-2">
                    ...
                    <input type="text" 
                           ...
                           required 
                           placeholder="Contoh: Pemeliharaan Sistem Cetak Online"
                ...
                <div class="md:col-span-2 space-y-2">
                    ...
                    <textarea name="isi" 
                              ...
                              class="w-full p-4 text-xs font-medium bg-white border border-red-300 rounded-xl focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 text-gray-700 shadow-sm transition resize-none overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">{{ old('isi', $pengumuman->isi) }}</textarea>
