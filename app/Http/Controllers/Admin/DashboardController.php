...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // 3. Data Status (Lebih efisien, hanya 1 kali query ke database)
        ...
        $statusCounts = [
            'diproses' => $statuses['Diproses'] ?? 0,
            'dicetak'  => $statuses['Dicetak'] ?? 0,
            'selesai'  => $statuses['Selesai'] ?? 0,
        ];

        // 4. Query Produk Terlaris (Diubah menggunakan JOIN ID agar lebih akurat & cepat)
